 ...
 if ($data->rowCount() > 0) {
    ...
    foreach ($data as $row) {
        ...
        if (!in_array($valor, $dadosUnicos)) {
            ...
            echo "<div class=''><h4><span id='oportunidades'>".$valor."</span></h4></div>";
        }
    }
} else {
    echo "<p><span id='nulo'>Não há oportunidades e valores a serem restituídos neste perfil</p>";
}
